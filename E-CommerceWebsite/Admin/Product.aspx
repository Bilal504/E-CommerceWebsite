<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="E_CommerceWebsite.Admin.Product" %>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Price must be in decimals"
                                                            ForeColor="Red"
                                                ...
                                                <%-- Product Category --%>
                                                  <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Product Category Is Required" ForeColor="Red"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="ddlCategories" InitialValue="0"></asp:RequiredFieldValidator>
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EcommerceCapstoneConnectionString %>" SelectCommand="SELECT [CategoryId], [Name] FROM [Categories]"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server"
                                                                        CausesValidation="false" CssClass="badge badge-primary"
